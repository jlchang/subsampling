...
inputPath = "/cil/shed/sandboxes/jlchang/echou/subsampleScripts/percentCalcInputTest"
...
for i in range(0,len(bams)):
	...
	flagDirPath = "/cil/shed/sandboxes/jlchang/echou/flagstats/"+names[i]+"_"+epitopes[i] #makes path to directory
	...
	bedDirPath = "/cil/shed/sandboxes/jlchang/echou/bedtools/"+programs[i]+"/"+names[i]+"_"+epitopes[i] #makes path to directory
	os.mkdir(bedDirPath, 0755)
	
	#system call to make flagstat
	flagstatOutputFilepath = "/cil/shed/sandboxes/jlchang/echou/flagstats/"+names[i]+"_"+epitopes[i]+"/"+names[i]+"_"+epitopes[i]+"_wholebam.flagstat"
	...
	print "flagstatjobResult: " + flagstatjobResult
